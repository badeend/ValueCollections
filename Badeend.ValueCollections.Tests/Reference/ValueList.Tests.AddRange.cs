...
namespace Badeend.ValueCollections.Tests.Reference
{
    ...
    public abstract partial class ValueList_Tests<T> : IList_Generic_Tests<T>
    {
        ...
        {
            ValueList<T> list = GenericListFactory(listLength);
            ValueList<T> listBeforeAdd = list.ToList();
        ...
        {
            ValueList<T> list = GenericListFactory(0);
        ...
        {
            ValueList<T> list = GenericListFactory(count: 1);
