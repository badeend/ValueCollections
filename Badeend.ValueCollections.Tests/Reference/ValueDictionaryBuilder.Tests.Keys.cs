...
namespace Badeend.ValueCollections.Tests.Reference
{
    public class ValueDictionaryBuilder_Tests_Keys : ICollection_Generic_Tests<string>
    {
        ...
        {
            return new ValueDictionaryBuilder<string, string>().Keys;
        }
        ...
        [Fact]
        public void ValueDictionaryBuilder_KeyCollection_Constructor_NullDictionary()
        {
            Assert.Throws<ArgumentNullException>(() => new ValueDictionaryBuilder<string, string>.KeyCollection(null));
        }
    ...
    public class ValueDictionaryBuilder_Tests_Keys_AsICollection : ICollection_NonGeneric_Tests
    {
        ...
        [Theory]
        [MemberData(nameof(ValidCollectionSizes))]
        public void ValueDictionaryBuilder_KeyCollection_CopyTo_ExactlyEnoughSpaceInTypeCorrectArray(int count)
        {
