...
{
    public partial class ValueDictionary_Tests_string_string : ValueDictionary_Tests<string, string>
    {
    ...
    public class ValueDictionary_Tests_int_int : ValueDictionary_Tests<int, int>
    {
    ...
    public class ValueDictionary_Tests_SimpleInt_int_With_Comparer_WrapStructural_SimpleInt : ValueDictionary_Tests<SimpleInt, int>
    {
