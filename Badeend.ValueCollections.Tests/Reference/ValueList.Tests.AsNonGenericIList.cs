...
namespace Badeend.ValueCollections.Tests.Reference
{
    ...
    /// </summary>
    public abstract partial class ValueList_Tests_AsNonGenericIList : IList_NonGeneric_Tests
    {
        ...
        protected virtual ValueList<string> GenericListFactory()
        {
            return new ValueList<string>();
        }

        protected virtual ValueList<string> GenericListFactory(int count)
        {
